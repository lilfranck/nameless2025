...
const projectsData = [
  {
    id: 1,
    title: "APPHISTAMINE — Application Mobile",
    description: "App de gestion d'allergies alimentaires et d'histamine",
    category: "dev",
    tags: ["Figma", "React", "NestJS", "PostgreSQL"],
  ...
  {
    id: 2,
    title: "IPHONE 17 ARRIVALS — Visuel Branding",
    description: "Visuel de branding pour une marque de smartphones",
    category: "branding",
  ...
  {
    id: 3,
    title: "TRADEZ — Trading App",
    description: "Application mobile de trading avec fonctionnalités avancées",
    category: "dev",
    tags: ["React", "Nest", "Vercel", "PostgreSQL"],
  ...
  },
  {
    id: 4,
    title: "Arise — Web App",
    description: "Application web de gestion des concours universitaires",
    category: "dev",
    tags: ["NextJS", "nest", "Firebase"],
